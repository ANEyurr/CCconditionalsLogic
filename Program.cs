...
namespace ChooseYourOwnAdventure
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (doorChoice == "KNOCK")
            {
                Console.WriteLine("A voice behind the door speaks. It says, Answer this riddle: You walk into the hallway and see a light coming from under a door down the hall. You walk towards it. Do you open it or knock?\"");
